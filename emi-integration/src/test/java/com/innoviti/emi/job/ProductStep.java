...
public class ProductStep extends SetupWithJob{
  
  @Autowired
  private Flow  modelProductMasterToProductFlow;
  
  @Test
  public void testProduct() throws Exception{
    Job job = buildJob(modelProductMasterToProductFlow, "modelProductMasterToProductJob");
