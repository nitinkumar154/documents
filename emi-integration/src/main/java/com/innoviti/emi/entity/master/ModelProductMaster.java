...
@Entity
@Table(name = "model_product_bfl")
public class ModelProductMaster implements Serializable{

  private static final long serialVersionUID = -4359304962399047199L;

  @EmbeddedId
  private ModelProductMasterComposite modelProductMasterComposite;
  ...
  public ModelProductMasterComposite getModelProductMasterComposite() {
    return modelProductMasterComposite;
  }

  public void setModelProductMasterComposite(
      ModelProductMasterComposite modelProductMasterComposite) {
    this.modelProductMasterComposite = modelProductMasterComposite;
  }
  ...
  public String toString() {
    ...
    builder.append(modelProductMasterComposite.getModelId());
    builder.append("|");
    builder.append(modelProductMasterComposite.getCode());
