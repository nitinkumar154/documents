...
@Entity
@Table(name = "dealer_product_bfl")
public class DealerProductMaster {

  @EmbeddedId
  private DealerProductMasterComposite dealerProductMasterComposite;
  ...
  public void setDealerProductMasterComposite(
      DealerProductMasterComposite dealerProductMasterComposite) {
    this.dealerProductMasterComposite = dealerProductMasterComposite;
  }

  public DealerProductMasterComposite getDealerProductMasterComposite() {
    return dealerProductMasterComposite;
  }
  ...
  public String toString() {
    ...
    builder.append(dealerProductMasterComposite.getSupplierId());
    builder.append("|");
    builder.append(dealerProductMasterComposite.getCode());
