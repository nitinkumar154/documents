package com.innoviti.emi.exception.handler;
...
public class GlobalExceptionHandler {
  ...
  @ExceptionHandler(value = {HttpMessageNotReadableException.class, BadRequestException.class,
  ...
  @ExceptionHandler(value = {RequestNotCompletedException.class})
  public ErrorMessage requestNotCompleted(Exception e) {
    return new ErrorMessage(getMessage(e), 417);
  }
 
  @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
  @ExceptionHandler(value = {AlreadyMappedException.class})
  public ErrorMessage alreadyMappedException(Exception e) {
    return new ErrorMessage(getMessage(e), 422);
  }
